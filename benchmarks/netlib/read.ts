...
export const timeout: readonly string[] = [
  "25FV47", "AGG", "BANDM", "BNL1", "BRANDY", "DEGEN2", "DEGEN3", "E226", "FFFFF800",
  "SCFXM2", "SCFXM3", "SCSD1", "SCSD8", "STOCFOR2", "WOOD1P", "KLEIN3"
]
...
export const ok: readonly string[] = [
  ...
  "SHIP04L", "SHIP04S", "SHIP08L", "SHIP08S", "SHIP12S", "SHIP12L", "STOCFOR1", "KLEIN2"
]
